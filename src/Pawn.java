public class Pawn extends Piece {
    ...
    public void move(String newPosition) {
        ...
        } else if (isBlack || Integer.parseInt(newPos[1]) < Integer.parseInt(currPos[0]) + 3) {
            // can move 2 if isblack
            System.out.println("legal");
        } else if (isBlack || Integer.parseInt(newPos[1]) < Integer.parseInt(currPos[0])) {
            System.out.println("not legal");
        } else if (Integer.parseInt(newPos[1]) > Integer.parseInt(currPos[1]) + 1) {
            System.out.println("not legal");
        } else {
            System.out.println("not legal");
        }
